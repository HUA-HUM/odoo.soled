...
class RetailerFravegaProduct(models.Model):
    ...
    status_code = fields.Char(string="Codigo estado", index=True)
    ...
    category_id = fields.Char(string="Categoria ID")
    ...
    def action_sync_products(self):
        ...
        return self._notification(
            _("Catalogo Fravega actualizado. Creados: %(created)s. Actualizados: %(updated)s. Omitidos: %(skipped)s.")
